...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.tri2vtx, vtx2xyz = del_msh.del_msh.load_wavefront_obj_as_triangle_mesh(str(path_file))
    ...
    def mouse_press_callback(self, event):
        ...
        tri2node2color = numpy.zeros([num_tri, 3, 3], dtype=numpy.float32)
        self.tri2flag[tri_index] = 1 - self.tri2flag[tri_index]
        tri2node2color[self.tri2flag == 0, :, 0] = 1.
        tri2node2color[self.tri2flag == 0, :, 1] = 1.
        tri2node2color[self.tri2flag == 0, :, 2] = 1.
        tri2node2color[self.tri2flag == 1, :, 0] = 1
        tri2node2color[self.tri2flag == 1, :, 1] = 0
        tri2node2color[self.tri2flag == 1, :, 2] = 0
        self.glwidget.list_drawer[0].update_color(tri2node2color)
